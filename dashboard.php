...
<head>
    ...
    <title>Dashboard | E-Market</title>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="row">
                    <div class="col-sm-4 admin">
                        <a href="add_product.php">
                            <img src="images/admin/add_inventory.png"><br>Add Inventory</a>
                        </a>
                    </div>

                    <div class="col-sm-4 admin">
                        <a href="edit_product.php">
                            <img src="images/admin/edit_inventory.png"><br>Edit Inventory
                        </a>
                    </div>

                    <div class="col-sm-4 admin">
                        <a href="add_category.php">
                        <img src="images/admin/add_category.png"><br>
                        Add Category</a>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 admin">
                    <a href="edit_category.php"><img src="images/admin/edit_category.png"><br>
                    Edit Category</a></div>
                    <div class="col-sm-4 admin">
                        <a href="admin-shop.php"><img src="images/admin/view_all.png"><br>
                        View All Invetory</a>                        
                    </div>
                    <div class="col-sm-2">&nbsp;</div>
                </div>
