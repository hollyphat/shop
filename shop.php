...
<?php
    ...
    $total = mysql_num_rows(mysql_query("SELECT null FROM inventory"));
    $per_page = 9;
...
?>
    ...
    <title>All Products | E-Market</title>
                    ...
                    <?php
                        $query = mysql_query("SELECT * FROM inventory")
                            ...
                            if($query_total==0){
                                ...
                                //ok
                                echo "<div class='alert text-center alert-info'>".$total ." inventory found</div>";
